...
// Taken from gio source code


/*
dp => device independent pixel
sp => scaled pixel
px => display dependent pixels
*/
...
const dpi float64 = 96.0

func GetDefaultMetric() Metric {
	const inchPerDp = 1.0 / 96.0
	ppdp := float32(dpi) * inchPerDp
